...
public class Unterrichtsraum extends Raum{
    ...
    public Unterrichtsraum(String nummer, String geschoss, double grundflaeche,int sitzplätze, boolean lehrerPCvorhanden, boolean whiteboardVorhanden ) {
        super(nummer, geschoss, grundflaeche);
